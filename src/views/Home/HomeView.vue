<template>
          ...
          >
            ...
            <div class="sm:px-4 p-2.5 pt-0">
              <p class="font-normal">
                ...
                be used to create images that tell stories, express emotions, or
                document reality. it can be fun, challenging, or rewarding. It
                can also be a hobby, a profession, or a passion. 📷
              </p>
            </div>
          ...
          <div class="box p-5 px-6">
            ...
            <div class="side-list">
              <div class="side-list-item">
                ...
                <div class="flex-1">
                  <a href="timeline.html"
                    ><h4 class="side-list-title">John Michael</h4></a
                  >
              ...
              <div class="side-list-item">
                ...
                <div class="flex-1">
                  <a href="timeline.html"
                    ><h4 class="side-list-title">Monroe Parker</h4></a
                  >
              ...
              <div class="side-list-item">
                ...
                <div class="flex-1">
                  <a href="timeline.html"
                    ><h4 class="side-list-title">James Lewis</h4></a
                  >
                  <div class="side-list-info">125k Following</div>
                </div>
                <button
              ...
              <div class="side-list-item">
                ...
                <div class="flex-1">
                  <a href="timeline.html"
                    ><h4 class="side-list-title">Alexa stella</h4></a
                  >
  ...
  <!-- post preview modal -->
  <div
    class="hidden lg:p-20 max-lg:!items-start"
    id="preview_modal"
    uk-modal=""
  >
    <div
      ...
      >
          ...
          <div class="shadow relative -mx-5 px-5 py-3 mt-3">
            <div class="flex items-center gap-4 text-xs font-semibold">
              <div class="flex items-center gap-2.5">
                <button
                  type="button"
                  class="button__ico text-red-500 bg-red-100 dark:bg-slate-700"
                >
                  <ion-icon class="text-lg" name="heart"></ion-icon>
                </button>
                <a href="#">1,300</a>
        ...
        <div class="bg-white p-3 text-sm font-medium flex items-center gap-2">
          ...
          <div class="flex-1 relative overflow-hidden">
            ...
            >
              <ion-icon
                class="text-xl flex text-blue-700"
                name="image"
              ></ion-icon>
              <ion-icon
                class="text-xl flex text-yellow-500"
                name="happy"
              ></ion-icon>
            </div>
          </div>
    ...
    >
      ...
      <div class="space-y-5 mt-7">
        ...
        <div class="flex justify-between items-center">
          ...
          <button type="button" class="button bg-blue-500 text-white px-8">
            Create
          </button>
        </div>
      </div>
